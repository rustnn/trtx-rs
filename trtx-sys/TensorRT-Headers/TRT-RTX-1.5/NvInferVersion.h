...
#define TRT_MINOR_RTX 5
#define TRT_PATCH_RTX 0
#define TRT_BUILD_RTX 114
#define NV_TENSORRT_MAJOR TRT_MAJOR_RTX //!< TensorRT major version.
#define NV_TENSORRT_MINOR TRT_MINOR_RTX //!< TensorRT minor version.
#define NV_TENSORRT_PATCH TRT_PATCH_RTX //!< TensorRT patch version.
#define NV_TENSORRT_BUILD TRT_BUILD_RTX //!< TensorRT build number.
